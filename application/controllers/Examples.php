...
class Examples extends MY_Controller
{
    ...
    public function create_user()
    {
        ...
        $user_data = array(
            'user_name'     => 'iridion2015',
            'user_pass'     => 'Retinitis9',
            'user_email'    => 'iridion2015@yandex.com',
...
// --------------------------------------------------------------
//		Methods for Testing onlly...
// --------------------------------------------------------------

    function random_num() {
    	//$random_unique_int = mt_rand(1200, 4294967295);
		$random_unique_int = mt_rand();
		echo '<b>Rand Number: </b>'. $random_unique_int;
    }
	
	function show_register_form() {
        $html = $this->load->view('examples/page_header', '', TRUE);
        $html .= $this->load->view('examples/register_form', '', TRUE);
        $html .= $this->load->view('examples/page_footer', '', TRUE);
